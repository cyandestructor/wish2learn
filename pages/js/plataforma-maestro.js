...
function anadircatego() {
  ...
  anadir.innerHTML = `
    ...
    <button type="sumbit" class="btn btn-success">Enviar para revisión</button>
    </form>
    </div>
    `;
}
                    ...
                    <div id="padreLecciones" class="panel panel-default">
                      ...
                      <div id="collapse1" class="panel-collapse collapse in">
                        ...
                        <div class=""> <!--agregarmas2 -->
                          <a type="button" id="btndinamic" href="#" onclick="crearmascards()" class="tamanoicon btn-info"><i class="bi bi-node-plus"></i></a> 
...
var division3 = document.getElementById("accordion");
...
function crearlec() {
  ...
  /*myCard.innerHTML=`*/
  alert("Se agrego una nueva Lección");
  const myCard2 = document.getElementById("accordion");
  myCard2.lastElementChild.innerHTML =
    `
